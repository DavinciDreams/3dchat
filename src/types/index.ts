...
export const EXTENDED_ANIMATIONS = [
  ...
  'aimingGun', 'angryGesture_1', 'backflip', 'bashful', 'beckoning', 'blowAKiss', 'boredmelancholyIdle_1', 'buttonPushing', 'cartwheel', 'catwalkTwistLToWalk180', 'catwalkWalking', 'cockyHeadTurn', 'crouchToStand', 'dancingTwerk', 'defeatIdle', 'disappointed', 'entry', 'fishingCast', 'floating', 'gettingUp', 'guitarPlaying', 'happyIdle', 'hipHopDancing', 'jumpingDown', 'jumpingJacks', 'kiss', 'kneeling', 'layingIdle', 'lookAround', 'lookOverShoulder', 'lowCrawl', 'lyingDown', 'militarySignaling', 'nervouslyLookAround', 'openDoor', 'pacingAndTalkingOnAPhone', 'patting', 'pettingAnimal', 'petting', 'pianoPlaying', 'playingDrums', 'playingTheViolin', 'plank', 'plotting', 'praying', 'roar', 'rummaging', 'runningUpStairs', 'searchingPockets', 'shrugging', 'sillyDancing', 'singing_1', 'sitToStand', 'sittingDisapproval', 'sittingTalking', 'sitting', 'situps', 'smoking', 'sneakingForward', 'sneakyWalking', 'standToSit', 'standardRun', 'startClimbingLadder', 'talking', 'thinking', 'vaultOverBox', 'victoryIdle', 'yawn',
] as const;
