...
export const EXTENDED_ANIMATIONS = [
  ...
  // Movement
  'walking', 'jogBackwards', 'jumping', 'climbing', 'zombieStandUp', 'turnRight', 'turnLeft', 'catwalkWalkStopTwistR', 'kipUp', 'paddling', 'sadWalk', 'skateboarding', 'standingArguing', 'standingJump', 'startWalking', 'strongGesture', 'swimming', 'throwing', 'twistDance', 'typing', 'textingAndWalking',
  // Sports & Activities
  'golfBadShot', 'golfPrePutt', 'golfDrive', 'golfPuttVictory',
  // New animations from Meshy AI
  'aimingGun', 'angryGesture_1', 'backflip', 'bashful', 'beckoning', 'blowAKiss', 'boredmelancholyIdle_1', 'buttonPushing', 'cartwheel', 'catwalkTwistLToWalk180', 'catwalkWalking', 'cockyHeadTurn', 'crouchToStand', 'dancingTwerk', 'defeatIdle', 'disappointed', 'entry', 'fishingCast', 'floating', 'gettingUp', 'guitarPlaying', 'happyIdle', 'hipHopDancing', 'jumpingDown', 'jumpingJacks', 'kiss', 'kneeling', 'layingIdle', 'lookAround', 'lookOverShoulder', 'lowCrawl', 'lyingDown', 'militarySignaling', 'nervouslyLookAround', 'openDoor', 'pacingAndTalkingOnAPhone', 'patting', 'pettingAnimal', 'petting', 'pianoPlaying', 'playingDrums', 'playingTheViolin', 'plank', 'plotting', 'praying', 'roar', 'rummaging', 'runningUpStairs', 'searchingPockets', 'shrugging', 'sillyDancing', 'singing_1', 'sitToStand', 'sittingDisapproval', 'sittingTalking', 'sitting', 'situps', 'smoking', 'sneakingForward', 'sneakyWalking', 'standToSit', 'standardRun', 'startClimbingLadder', 'talking', 'textingAndWalking', 'thinking', 'vaultOverBox', 'victoryIdle', 'yawn',
] as const;
