/**
 * Animation Trigger Keywords Configuration
 * 
 * Maps keywords to animations for the text-based animation trigger system.
...
/**
 * Keyword to animation mappings for text-based animation triggers
 * 
 * Each category contains keywords that, when found in text,
 * trigger the associated animations.
 */
export const ANIMATION_TRIGGER_KEYWORDS: KeywordMapping[] = [
  // Greetings
  {
