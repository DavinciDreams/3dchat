      ...
      >
        ...
        >
          ...
          <input
            ...
            className="flex-1 min-w-0 bg-gray-900 border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-teal-500/50 disabled:opacity-50"
          />
